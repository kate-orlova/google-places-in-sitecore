...
2. **Project layer** with a _GooglePlacesImport_ project implementing the main SiteCron task _..\src\Project\GooglePlacesImport\SitecronTasks\ImportGooglePlaces.cs_ for importing data from GooglePlaces to Sitecore.
...
* GooglePlaceBasicDataFields
* GooglePlaceBasicDataCacheMinutes
* GooglePlaceContactDataFields
* GooglePlaceContactDataCacheMinutes
* GooglePlaceAtmosphereDataFields
